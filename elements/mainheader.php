...
include_once("../config/authenticated.php");
...
<head>
  ...
  <title>Dashboard - Tasks Management</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="<?php echo BASE_PATH;?>assets/img/favicon.png" rel="icon">
  ...
  <link href="<?php echo BASE_PATH;?>assets/vendor/simple-datatables/style.css" rel="stylesheet">
